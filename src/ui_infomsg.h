...
public:
    ...
    {
        InfoMsgGroupBox->setTitle(QApplication::translate("InfoDialog", "Qirda", 0, 0));
...
"<p style=\"-qt-paragraph-type:empty; margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:'SUSE Sans'; font-size:12pt;\"></p></body></html>", 0, 0));
        Q_UNUSED(InfoDialog);
    } // retranslateUi
